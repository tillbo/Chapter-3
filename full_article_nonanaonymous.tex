...
Table \ref{tab:Self-reported-diabetes-duration} panel A shows the results of the linear duration analysis, which indicated that male and female employment probabilities fell every year, with a larger effect shown by the within coefficient. 
