...
using the following rules (Table :
\providecommand{\tabularnewline}{\\}

\caption{\label{tab:Pooled-sample-characteristics}\textbf{Inconsistencies in diabetes self-report in MxFLS}}
\begin{table}{H}
\begin{center}
\begin{tabular}{llc}
...
the construction of the wealth index is detailed in \citet{Seuring2015}.
