...
\noindent 
\begin{equation}
Y_{it}=\beta_{0}+\beta_{1}Dduration_{it}+\beta_{2}X_{it}+c_{i}+\gamma_{t}+u_{it},\label{eq:duration_linear}
\end{equation}

where $\beta_{1}Dduration_{it}$ is a continuous variable indicating years since first diabetes diagnosis.
...
\noindent 
\begin{equation}
Y_{it}=\delta_{0}+g(Dduration_{it})+\delta_{2}X_{it}+c_{i}+\gamma_{t}+u_{it}.\label{eq:splines}
\end{equation}


with $g(Dduration_{it})=\sum_{n=1}^{N}\delta_{n}\cdot max\{Dyears_{it}-\eta_{n-1}\}I_{in}$
