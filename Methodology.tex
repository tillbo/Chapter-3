...
\noindent 
\begin{equation}
Y_{it}=\beta_{0}+\beta_{1}D_d{it}+\beta_{2}X_{it}+c_{i}+\gamma_{t}+u_{it},\label{eq:duration_linear}
\end{equation}

where $\beta_{1}D_d{it}$ is a continuous variable indicates years since first diabetes diagnosis.
