...
where $\beta_{1}Dduration_{it}$ is a continuous variable indicates years since first diabetes diagnosis.
...
where $\beta_{1}Dobj_{i}$ is equal to $1$ if HbA1c $\leq 6.5%$.
