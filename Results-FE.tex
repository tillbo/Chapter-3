...
\toprule
                &\multicolumn{3}{c}{Employment}                          &\multicolumn{3}{c}{Log hourly wages}                    &\multicolumn{3}{c}{Weekly work hours}                  \\\cmidrule(lr){2-4}\cmidrule(lr){5-7}\cmidrule(lr){8-10}
...
\toprule
                &\multicolumn{3}{c}{Log hourly wages}                   &\multicolumn{3}{c}{Weekly work hours}                  \\\cmidrule(lr){2-4}\cmidrule(lr){5-7}
