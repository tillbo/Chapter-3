...
\subsubsection{\noindent \label{sec:{Panel_data_specifications}Panel data strategy}
...
\subsubsection{\noindent \label{sec:{OLS_specifications}Cross-sectional data strategy}
